    ...
    return(
        ...
        <Content>
          <View style={styles.headerViewStyle}>
           ...
           <List>
            <ListItem button onPress={() => navigate('MyWeb', { uri: 'https://github.com/facebook/react-native', title: 'FAQs'})}>
              <Text>FAQs</Text>
            </ListItem>
            ...
            <ListItem button onPress={() => navigate('MyWeb', { uri: 'https://github.com/facebook/react-native', title: 'T&Cs'})}>
